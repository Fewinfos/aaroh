        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-titanium-metallic mb-6 max-w-sm leading-relaxed">
              A national level hackathon organized by ARROH Student Clubs at
              M Kumarasamy College of Engineering, Karur.
            </p>

            <div className="space-y-3">
              <a href="mailto:info@multiverse2026.com" className="flex items-center gap-3 text-titanium-metallic hover:text-titanium-white transition-colors">
                <Mail size={16} />
                <span>info@multiverse2026.com</span>
              </a>
              ...
              <div className="flex items-start gap-3 text-titanium-metallic">
                ...
                <span>M Kumarasamy College of Engineering, Karur</span>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8 py-6">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <p className="text-titanium-metallic text-sm text-center md:text-left">
              © 2026 MULTIVERSE. All rights reserved. Organized by ARROH Student Clubs.
            </p>
            <button
              onClick={scrollToTop}
