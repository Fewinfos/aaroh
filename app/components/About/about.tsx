        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            <div className="about-description space-y-6 text-titanium-metallic text-lg leading-relaxed">
              <p>
                MULTIVERSE 2026 brings together the brightest minds in technology for two days of 
                innovation, collaboration, and breakthrough discoveries. Organized by ARROH Student Clubs 
                at M Kumarasamy College of Engineering, Karur.
              </p>
              <p>
                Experience intense hackathons, hands-on workshops, 
                and keynotes from industry leaders. Whether you&apos;re a developer, entrepreneur, or 
                tech enthusiast, MULTIVERSE is your gateway to what&apos;s next.
              </p>
            </div>
