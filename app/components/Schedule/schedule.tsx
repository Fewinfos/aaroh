...
const scheduleData = {
  "Day 1": {
    ...
    events: [
      ...
      { time: "02:00 PM", title: "HackMultiverse Kickoff", location: "Innovation Hub", type: "event" },
  ...
  "Day 3": {
    date: "March 3, 2026",
    events: [
      { time: "09:00 AM", title: "HackMultiverse Final Submissions", location: "Innovation Hub", type: "event" },
