...
const faqData: FAQItem[] = [
  {
    id: "what-is-titanium",
    question: "What is MULTIVERSE 2026?",
    answer: "MULTIVERSE 2026 is a national-level hackathon organized by ARROH Student Clubs (comprising 9 clubs) at M Kumarasamy College of Engineering, Karur. It features hackathons, workshops, competitions, and networking opportunities across cutting-edge tech domains.",
    category: "general",
    tags: ["symposium", "technology", "international"]
  },
  {
    id: "when-where",
    question: "When and where is MULTIVERSE 2026 taking place?",
    answer: "MULTIVERSE 2026 will be held on March 2-3, 2026 at M Kumarasamy College of Engineering, Karur. The event spans two days with exciting events and competitions.",
    category: "general",
    tags: ["date", "venue", "location"]
  },
  {
    id: "registration-process",
    question: "How do I register for MULTIVERSE 2026?",
  ...
  },
  {
    ...
    question: "What hackathons are available at MULTIVERSE 2026?",
  ...
  },
  {
    ...
    answer: "MULTIVERSE 2026 features hands-on workshops on AI/ML, Cloud Computing, DevOps, Cybersecurity, Web Development, Mobile App Development, and emerging technologies. All workshops include practical exercises and take-home resources.",
    category: "events",
  ...
  },
  {
    ...
    answer: "We provide assistance in finding nearby accommodations. Partner hotels offer special rates for MULTIVERSE participants. Hostel accommodations and shared stays can also be arranged through our accommodation portal.",
    category: "general",
  ...
  },
  {
    ...
    answer: "MULTIVERSE 2026 offers structured networking sessions, industry meetups, startup showcases, career fairs, and informal networking spaces. Our mobile app includes participant directory and networking features.",
    category: "events",
  ...
  },
  {
    ...
    answer: "Our support team is available 24/7 during the event. Contact us via email at support@multiverse2026.com, WhatsApp at +91-XXXXXXXXX, or visit the help desk at the venue. We also have live chat support on our website.",
    category: "general",
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="faq-header text-center mb-16">
          ...
          <p className="text-titanium-metallic text-base sm:text-lg max-w-3xl mx-auto leading-relaxed">
            Find answers to common questions about MULTIVERSE 2026. Can't find what you're looking for? 
        ...
        <div className="mt-20 text-center">
          <div className="titanium-card rounded-3xl p-8 max-w-2xl mx-auto">
            ...
            <p className="text-titanium-metallic mb-6 leading-relaxed">
              Our support team is available 24/7 to help you with any queries about MULTIVERSE 2026.
            </p>
